@if($paginator->total() > 0)
    <div class="row paginator-footer mt-3 small">
        <div class="col-12 col-lg-6 text-center text-lg-left text-xl-left align-self-center">
            <p class="info-display mb-lg-0 mb-2 ">
                ...
                of
                <strong><span class="text-secondary">{{ $paginator->total() }}</span></strong>
                entries
