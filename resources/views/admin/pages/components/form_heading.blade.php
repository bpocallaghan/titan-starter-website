<div class="row">
    ...
    <div class="col col-md-4">
        <div class="form-group">
        	...
        	{!! form_select('heading_element', (['h1' => 'Heading 1', 'h2' => 'Heading 2', 'h3' => 'Heading 3', 'h4' => 'Heading 4']), ($errors && $errors->any()? old('heading_element') : (isset($item)? $item->heading_element : 'h2')), ['class' => 'select2 form-control ' . form_error_class('heading_element', $errors)]) !!}
