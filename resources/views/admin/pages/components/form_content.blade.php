<div class="row">
    <div class="col col-md-12">
        <section class="form-group">
            ...
            <textarea class="form-control summernote {{ form_error_class('content', $errors) }}" id="content-content" name="content" rows="30" placeholder="Please insert the Content">{{ ($errors && $errors->any()? old('content') : (isset($item)? $item->content : '')) }}</textarea>
