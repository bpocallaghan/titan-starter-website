                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-radio mr-5">
                                                <input class="custom-control-input" type="radio" id="gender1" name="gender" value="male" {{ ($errors->any() && old('gender') == 'male'? 'checked="checked"' : user()->gender == 'male'? 'checked="checked"':'') }}>
                                                <label for="gender1" class="custom-control-label">Male</label>
                                            </div>

                                            <div class="custom-control custom-radio">
                                                <input class="custom-control-input" type="radio" id="gender2" name="gender" value="female" {{ ($errors->any() && old('gender') == 'female'? 'checked="checked"' : user()->gender == 'female'? 'checked="checked"':'') }}>
