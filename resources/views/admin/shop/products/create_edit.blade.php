                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group {{ form_error_class('special_amount', $errors) }}">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text">N$</span></div>
                                        <input type="text" class="form-control" id="special_amount" name="special_amount" placeholder="Please insert the Amount" value="{{ ($errors && $errors->any()? old('special_amount') : (isset($item)? $item->special_amount : '')) }}">
                                    </div>
