...
class CategoriesController extends AdminController
{
	...
	public function index()
	{
		...
		return $this->view('news.categories.index')->with('items', NewsCategory::all());
	}
	...
	{
		return $this->view('news.categories.create_edit');
	}
	...
	{
		return $this->view('news.categories.show')->with('item', $category);
	}
	...
	{
		return $this->view('news.categories.create_edit')->with('item', $category);
	}
